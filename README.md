...
Это одна из проектных работ Яндекс практикума, главное ее отличие от предыдущих, это то, что реализованы несколько popup с применение JavaScript, а формы валидированы. Все изменения сохраняются на сервере.
